...
bkcore.hexgl.Gameplay.prototype.end = function(result)
{
	...
	{
		if(this.hud != null) this.hud.display("Chegada");
		this.step = 100;
	}
	else if(result == this.results.DESTROYED)
	{
		if(this.hud != null) this.hud.display("PERDA TOTAL");
		this.step = 100;
	}
}
...
bkcore.hexgl.Gameplay.prototype.update = function()
{
	...
	{
		if(this.hud != null) this.hud.display("VAI", 0.5);
		this.step = 4;
		this.timer.start();
